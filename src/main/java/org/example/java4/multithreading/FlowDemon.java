...
public class FlowDemon {
    ...
    private static void withoutConcurrency() {
        ...
        System.out.println("Без многопоточность - " + (after - before));
    }
    ...
    private static void withConcurrency() {
        ...
        System.arraycopy(array, 0, firstHalf, 0, HALF);//исходный массив, с какого элемента, куда копируем, с какого
        // элемента, и какое кол-во
        ...
        long after = System.currentTimeMillis();
        System.out.println("C многопоточностью - " + (after - before));
    }
}
